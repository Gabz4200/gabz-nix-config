# Add a session steam-gamescope-session.target
# TODO: open PR
{
  config,
  lib,
...
in {
  ...
  config = lib.mkIf cfg.enable {
    ...
    # Create systemd target for steam gamescope session
    systemd.user.targets.steam-gamescope-session = lib.mkIf cfg.gamescopeSession.enable {
